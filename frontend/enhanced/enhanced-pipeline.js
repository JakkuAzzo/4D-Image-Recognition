/**
 * Enhanced 7-Step Facial Recognition Pipeline JavaScript (moved into enhanced/)
 * Note: A legacy copy remains at /static/enhanced-pipeline.js for back-compat.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeThreeJS();
    console.log('🚀 Enhanced 7-Step Facial Pipeline initialized (enhanced/)');
});
